...
input_file="icurl/libd/"$pop"/"$pop"_"$chr"_min_hom"
# input_file="icurl/libd/"$pop"/"$pop"_"$chr
output_dir=$output"/icurl/"
output_file=$output_dir"/"$pop"_"$chr"_"$code"_perm"$i 
...
# ../plink2 --bfile $input_file \
#     --keep "input_files/updated/cb/cb.fam" \
#     --geno-counts  \
