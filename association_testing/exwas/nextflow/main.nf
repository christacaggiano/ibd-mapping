...
// ====================================================================================
params.output_dir = '/sc/arion/projects/igh/kennylab/christa/mapping_ibd/rare_variant_gwas/phecodes/aj/nextflow'
params.geno_dir   = '/sc/arion/projects/igh/kennylab/christa/mapping_ibd/rare_variant_gwas/geno'
params.pop        = 'aj'
params.test_type = 'recessive' // Options: 'recessive', 'dominant', 'additive'
params.test_pheno = null // Set to a specific phenotype to test, or null for all
params.pheno = '/sc/arion/projects/igh/kennylab/christa/mapping_ibd/rare_variant_gwas/phecodes/aj/pcs5/phecodes_all_pcs5_ID_phen.txt' 
params.covar = '/sc/arion/projects/igh/kennylab/christa/mapping_ibd/rare_variant_gwas/phecodes/aj/pcs5/phecodes_all_pcs5_ID_covs.txt'
...
process combine_and_cleanup {
    publishDir "${params.output_dir}/${params.test_type}", mode: 'copy'
